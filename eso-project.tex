...
% para promover quebras de linhas em URLs
% (referencias:	http://tex.stackexchange.com/questions/101195/line-breaks-and-the-url-package e
%		http://tex.stackexchange.com/questions/3033/forcing-linebreaks-in-url/10401)
\renewcommand{\UrlBreaks}%
	{\do\/\do\a\do\b\do\c\do\d\do\e\do\f\do\g\do\h\do\i\do\j\do\k\do\l\do\m%
	 \do\n\do\o\do\p\do\q\do\r\do\s\do\t\do\u\do\v\do\w\do\x\do\y\do\z\do\A%
	 \do\B\do\C\do\D\do\E\do\F\do\G\do\H\do\I\do\J\do\K\do\L\do\M\do\N\do\O%
	 \do\P\do\Q\do\R\do\S\do\T\do\U\do\V\do\W\do\X\do\Y\do\Z}
...
O tester também deve estar no levantamento de requisitos, para prover uma visão mais funcional que permita que a definição da especificação seja definida de uma forma funcional e testável, sugerindo alternativas que possam ser mais práticas para realizar, levantando exemplos e contexto para cada história, e garantindo a verificabilidade dos requisitos \cite{society_software_2004}. % pg 2-1
